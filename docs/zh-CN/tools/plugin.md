...
openclaw plugins install <path>                 # 将本地文件/目录复制到 ~/.openclawcn/extensions/<id>
...
- `openclaw plugins install <npm-spec>` 会使用 `npm pack`，提取到 `~/.openclawcn/extensions/<id>/`，并在配置中启用它。
