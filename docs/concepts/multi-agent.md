...
- **Session store** (chat history + routing state) under `~/.openclawcn/agents/<agentId>/sessions`.
...
available from `~/.openclawcn/skills`. See [Skills: per-agent vs shared](/tools/skills#per-agent-vs-shared-skills).
...
- Workspace defaults to `~/.openclawcn/workspace` (or `~/.openclawcn/workspace-<profile>` when `OPENCLAW_PROFILE` is set).
- State defaults to `~/.openclawcn/agents/main/agent`.
...
Each agent gets its own workspace with `SOUL.md`, `AGENTS.md`, and optional `USER.md`, plus a dedicated `agentDir` and session store under `~/.openclawcn/agents/<agentId>`.
...
```json5
{
  agents: {
    list: [
      { id: "alex", workspace: "~/.openclawcn/workspace-alex" },
      { id: "mia", workspace: "~/.openclawcn/workspace-mia" },
    ],
  },
  bindings: [
    {
...
```json5
{
  agents: {
    list: [
      { id: "main", workspace: "~/.openclawcn/workspace-main" },
      { id: "coding", workspace: "~/.openclawcn/workspace-coding" },
    ],
  },
  bindings: [
...
```json5
{
  agents: {
    list: [
      { id: "main", workspace: "~/.openclawcn/workspace-main" },
      { id: "alerts", workspace: "~/.openclawcn/workspace-alerts" },
    ],
  },
  bindings: [
...
`~/.openclawcn/openclaw.json` (JSON5):
...
```js
{
    ...
    list: [
      {
        ...
        default: true,
        name: "Home",
        workspace: "~/.openclawcn/workspace-home",
        agentDir: "~/.openclawcn/agents/home/agent",
      },
      {
        id: "work",
        name: "Work",
        workspace: "~/.openclawcn/workspace-work",
        agentDir: "~/.openclawcn/agents/work/agent",
      },
    ],
  },
  ...
  channels: {
    whatsapp: {
      accounts: {
        personal: {
          // Optional override. Default: ~/.openclawcn/credentials/whatsapp/personal
          // authDir: "~/.openclawcn/credentials/whatsapp/personal",
        },
        biz: {
          // Optional override. Default: ~/.openclawcn/credentials/whatsapp/biz
  ...
  agents: {
    list: [
      ...
      },
      {
        id: "opus",
        name: "Deep Work",
        workspace: "~/.openclawcn/workspace-opus",
