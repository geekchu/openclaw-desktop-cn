...
When you copy the **state directory** (`~/.openclawcn/` by default) and your **workspace**, you preserve:
...
<Steps>
  ...
  <Step title="Install OpenClaw on the new machine">
    ...
    It is fine if onboarding creates a fresh `~/.openclawcn/` -- you will overwrite it next.
  </Step>
