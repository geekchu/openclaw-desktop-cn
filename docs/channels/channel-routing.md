...
{
  agents: {
    list: [{ id: "support", name: "Support", workspace: "~/.openclawcn/workspace-support" }],
  },
  bindings: [
...
Session stores live under the state directory (default `~/.openclawcn`):

- `~/.openclawcn/agents/<agentId>/sessions/sessions.json`
