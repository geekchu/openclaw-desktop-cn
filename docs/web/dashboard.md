...
- **Localhost**: open `http://127.0.0.1:28789/`.
...
- Ensure the gateway is reachable (local: `openclaw status`; remote: SSH tunnel `ssh -N -L 28789:127.0.0.1:28789 user@host` then open `http://127.0.0.1:28789/`).
