...
export const metadata: Metadata = {
  ...
  description: 'OpenClaw 中文版免费下载。龙虾AI助理 桌面客户端支持 Windows/macOS 一键安装，接入 ChatGPT、Claude、DeepSeek 等 10+ 大模型，Clawdbot/MoltBot 中文版，通过微信钉钉飞书操控 AI。',
  alternates: {
    canonical: '/',
  },
}
...
const testimonials = [
  {
    ...
    content: '用了 OpenClaw 之后，工作效率提升了至少 3 倍。它能自动处理邮件、安排日程，甚至帮我订机票。真正的全能助手！',
  },
  {
    name: '李华',
    handle: '全栈工程师',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=lihua',
    content: '让 OpenClaw 帮我管理 GitHub issues、审查代码、自动部署项目。它就像一个永不疲倦的搭档，7x24 待命。',
  },
  {
    name: '王芳',
    handle: '智能家居爱好者',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=wangfang',
    content: '把 OpenClaw 接入了家里的智能设备，现在通过微信就能控制灯光、空调、扫地机器人。科技改变生活！',
  },
  {
    name: '陈伟',
    handle: '创业者',
    avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=chenwei',
    content: '每天早上自动发送今日待办、天气预报、重要邮件摘要。它比任何 App 都懂我的需求，已经离不开了。',
  },
]
    ...
    <main className="min-h-screen bg-[#fafafa]">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-[#fff0f1] via-[#fff7f7] to-[#fafafa]">
        <div className="relative max-w-4xl mx-auto px-5 pt-10 md:pt-14 pb-8 md:pb-10 text-center">
          ...
          <p className="text-[#ef4b58] text-sm md:text-base font-semibold tracking-widest uppercase mb-4 animate-fade-in-up" style={{ animationDelay: '0.15s' }}>
            龙虾AI助理 — 真正能帮你做事的 AI
          </p>
          <p className="text-2xl md:text-3xl max-w-2xl mx-auto mb-5 leading-relaxed font-medium animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
            一键安装，开箱即用，专为中文用户打造
          </p>

          {/* capability tags */}
          <div className="flex flex-wrap justify-center gap-2 md:gap-3 max-w-lg mx-auto mb-6 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            {['收发邮件', '管理日历', '航班值机', '代码审查', '智能家居', '极致安全'].map((tag) => (
              <span key={tag} className="bg-white/80 backdrop-blur text-[#555] text-sm md:text-base px-3.5 py-1.5 rounded-full border border-gray-200 shadow-sm">
                {tag}
              </span>
            ))}
          </div>
          ...
          <p className="text-[#999] text-xs md:text-sm max-w-md mx-auto leading-relaxed mb-6">
            Clawdbot / MoltBot 中文版，通过微信、钉钉、飞书等聊天应用即可操控，100% 兼容原版功能，为Windows用户定制优化安全保护
          </p>

          {/* Hero CTA */}
          <a href="#download" className="inline-flex items-center gap-2 bg-gradient-to-r from-[#ef4b58] to-[#ff7079] text-white text-base md:text-lg font-bold px-8 py-3.5 rounded-full shadow-lg shadow-[#ef4b58]/20 hover:shadow-xl hover:shadow-[#ef4b58]/30 hover:scale-105 transition-all duration-300" aria-label="免费下载 OpenClaw桌面版">
      ...
      {/* Download Section */}
      <section id="download" className="max-w-4xl mx-auto px-5 pt-3 md:pt-5 pb-8 md:pb-10 scroll-mt-4" aria-label="OpenClaw 下载">
        <h2 className="text-xl md:text-2xl font-bold text-[#1a1a2e] mb-1">
          <span className="text-[#ef4b58]">⟩</span> OpenClaw桌面版下载
        </h2>
        <p className="text-[#999] text-sm md:text-base mb-5">选择你的平台，一键安装，30 秒即可开始使用龙虾AI助理</p>
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-5 md:p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
            <div className="flex items-center gap-3 md:gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-[#bbb] text-xs md:text-sm">OpenClaw Windows 安装，支持 Win 10 / 11</p>
              </div>
            </div>
            <a
              href="https://openclawcn.net/update/artifacts/OpenClaw桌面版_0.2.0_x64-setup.exe"
      ...
      {/* AI Models Section */}
      <section className="bg-gradient-to-b from-[#fff0f1] to-[#fafafa] py-8 md:py-10" aria-label="AI 大模型接入">
        <div className="max-w-4xl mx-auto px-5">
          <h2 className="text-xl md:text-2xl font-bold text-[#1a1a2e] mb-1">
            <span className="text-[#ef4b58]">⟩</span> 一站式接入全球 AI 大模型
          </h2>
          <p className="text-[#999] text-sm md:text-base mb-5">OpenClaw 配置简单，无需逐个注册，统一接口调用，价格低至官方 <span className="text-[#ef4b58] font-bold">1/3</span></p>
      ...
      <section className="max-w-4xl mx-auto px-5 py-8 md:py-10" aria-label="安全保障">
        ...
        <p className="text-[#999] text-sm md:text-base mb-5">OpenClaw桌面版新增命令授权与目录访问控制，AI 再强也在你掌控之中</p>
      ...
      {/* Feature Showcase */}
      <section className="bg-gradient-to-b from-[#f0f7ff] to-[#fafafa] py-8 md:py-10" aria-label="OpenClaw 教程与配置界面">
        <div className="max-w-4xl mx-auto px-5">
          <h2 className="text-xl md:text-2xl font-bold text-[#1a1a2e] mb-1">
            <span className="text-[#ef4b58]">⟩</span> 可视化管理，一目了然
          </h2>
          <p className="text-[#999] text-sm md:text-base mb-5">告别命令行，OpenClaw 配置全程图形界面，参考教程即可轻松上手</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5">
            <ImageLightbox src="/images/dashboard.jpg" alt="服务状态监控" caption="服务状态一目了然，一键启停 AI 助手" />
            <ImageLightbox src="/images/ai.jpg" alt="AI 提供商配置" caption="灵活配置多家 AI 提供商，自定义 API 地址" />
            <ImageLightbox src="/images/feishu.jpg" alt="即时通讯连接" caption="连接多种聊天平台，打造全渠道 AI 助手" />
          </div>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-5 py-8 md:py-10" aria-label="集成服务">
        ...
        <p className="text-[#999] text-sm md:text-base mb-5">OpenClaw桌面版与 12+ 主流应用和服务无缝集成</p>
          ...
          {worksWithApps.map((app, i) => (
            ...
            >
              <Image
                ...
                loading="lazy"
              />
              <span className="text-[#666] text-[10px] md:text-xs text-center font-medium">{app.name}</span>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-5 py-10 md:py-14 text-center">
        ...
        <a href="#download" className="inline-flex items-center gap-2 bg-gradient-to-r from-[#ef4b58] to-[#ff7079] text-white text-base md:text-lg font-bold px-8 py-3.5 rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300" aria-label="免费下载 OpenClaw">
          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            <path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/>
            <polyline points="7 10 12 15 17 10"/>
            <line x1="12" y1="15" x2="12" y2="3"/>
      ...
      <section className="max-w-4xl mx-auto px-5 pb-8 md:pb-10" aria-label="常见问题">
        ...
        <div className="space-y-4">
          <details className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm group">
            <summary className="font-semibold text-[#1a1a2e] cursor-pointer text-sm md:text-base">OpenClaw桌面版和原版有什么区别？</summary>
            <p className="text-[#666] text-sm leading-relaxed mt-3">OpenClaw桌面版（龙虾AI助理）100% 兼容原版 OpenClaw 全部功能，同时提供图形化安装界面，无需命令行操作。针对中文用户深度优化：中文界面、中文文档教程、国内大模型接入（DeepSeek、通义千问、文心一言等）、更低的 API 价格，以及微信/钉钉/飞书等国内平台的集成支持。</p>
          </details>
          <details className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm group">
            <summary className="font-semibold text-[#1a1a2e] cursor-pointer text-sm md:text-base">OpenClaw桌面版安装需要什么条件？</summary>
            <p className="text-[#666] text-sm leading-relaxed mt-3">OpenClaw桌面版支持 Windows 10 及以上系统和 macOS 12 及以上版本，一键安装无需任何开发环境。下载对应平台的安装包后双击运行，30 秒即可完成配置，开始使用全部 AI 功能。</p>
          </details>
          <details className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm group">
            <summary className="font-semibold text-[#1a1a2e] cursor-pointer text-sm md:text-base">OpenClaw 和 Clawdbot、MoltBot 是什么关系？</summary>
            <p className="text-[#666] text-sm leading-relaxed mt-3">Clawdbot 和 MoltBot 是 OpenClaw 的曾用名，它们是同一个产品在不同发展阶段的名称。现在统一使用 OpenClaw 作为正式名称，OpenClaw 中文版（龙虾AI助理）继承了此前全部功能并持续更新，中文用户直接使用龙虾AI助理 即可。</p>
          </details>
          <details className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm group">
            <summary className="font-semibold text-[#1a1a2e] cursor-pointer text-sm md:text-base">如何查看 OpenClaw 教程和配置指南？</summary>
            <p className="text-[#666] text-sm leading-relaxed mt-3">OpenClaw桌面版内置图形化配置界面，无需手动编辑配置文件。安装后即可通过可视化面板完成 AI 提供商设置、聊天平台对接、安全权限管理等全部配置。我们也在持续完善中文教程文档，帮助你快速上手龙虾AI助理 的各项功能。</p>
          </details>
        </div>
      </section>
