...
export const metadata: Metadata = {
  ...
  description:
    "OpenClaw 中文版桌面客户端，一键安装开箱即用。专为中文用户打造的 AI 助手，接入 ChatGPT、Claude、DeepSeek 等 10+ 全球主流大模型，价格低至官方 1/3。支持 Windows/macOS，通过微信钉钉飞书即可操控，收发邮件、管理日历、代码审查、智能家居一站搞定。",
  keywords:
    "OpenClaw中文版,OpenClaw桌面版,OpenClaw一键安装,OpenClaw下载,龙虾AI助理,Clawdbot中文版,MoltBot中文版,OpenClaw Windows安装,OpenClaw配置,OpenClaw教程,AI助手,人工智能,桌面应用,大模型,ChatGPT,Claude,DeepSeek,AI桌面客户端,OpenClaw中国版",
  ...
  openGraph: {
    ...
    description:
      "OpenClaw 中文版，一键安装开箱即用。接入全球 10+ 主流大模型（ChatGPT/Claude/DeepSeek），价格低至官方 1/3。龙虾AI助理，你的全能桌面助手。",
    type: "website",
    locale: "zh_CN",
  ...
  twitter: {
    ...
    title: "OpenClaw桌面版 — 真正能帮你做事的 AI",
    description:
      "OpenClaw 中文版，一键安装开箱即用。龙虾AI助理，接入全球 10+ 大模型，价格低至官方 1/3。",
  },
  alternates: {
    canonical: "/",
  },
...
const jsonLd = [
  {
    ...
    description:
      "OpenClaw 中文版桌面客户端，一键安装开箱即用，专为中文用户打造的 AI 助手。接入 ChatGPT、Claude、DeepSeek 等全球主流大模型。",
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="zh-CN" suppressHydrationWarning>
      <head>
        <link rel="icon" href="/logos/openclaw.svg" type="image/svg+xml" />
        <script
