...
import { sendDiscordComponentMessage, sendMessageDiscord, sendPollDiscord, sendWebhookMessageDiscord, } from "./send.js";
...
export const discordOutbound = {
    ...
    sendPayload: async (ctx) => {
        ...
        const rawComponentSpec = discordData?.components ?? buildDiscordInteractiveComponents(payload.interactive);
    ...
    ...createAttachedChannelResultAdapter({
        ...
        sendPoll: async ({ cfg, to, poll, accountId, threadId, silent }) => await sendPollDiscord(resolveDiscordOutboundTarget({ to, threadId }), poll, {
            accountId: accountId ?? undefined,
            silent: silent ?? undefined,
            cfg,
        }),
