...
import { normalizePollDurationHours, normalizePollInput, } from "openclaw/plugin-sdk/media-runtime";
 ...
 */
export async function parseAndResolveRecipient(raw, accountId, cfg) {
...
async function sendDiscordMedia(rest, channelId, text, mediaUrl, filename, mediaLocalRoots, maxBytes, replyTo, request, maxLinesPerMessage, components, embeds, chunkMode, silent) {
