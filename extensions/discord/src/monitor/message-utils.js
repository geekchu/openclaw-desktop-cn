...
function resolveDiscordMediaSsrFPolicy(policy) {
    ...
    return {
        ...
        allowRfc2544BenchmarkRange: Boolean(DISCORD_MEDIA_SSRF_POLICY.allowRfc2544BenchmarkRange) ||
...
export async function resolveMediaList(message, maxBytes, fetchImpl, ssrfPolicy) {
    const out = [];
...
export async function resolveForwardedMediaList(message, maxBytes, fetchImpl, ssrfPolicy) {
