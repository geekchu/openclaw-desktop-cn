...
async function sendDiscordChunkWithFallback(params) {
    ...
    if (params.channelId && params.request && params.rest) {
        ...
        await sendWithRetry(() => sendDiscordText(rest, channelId, text, params.replyTo, request, params.maxLinesPerMessage, undefined, undefined, params.chunkMode), params.retryConfig);
        return;
    }
