...
export function isDiscordGroupAllowedByPolicy(params) {
    ...
    return evaluateGroupRouteAccessForPolicy({
        groupPolicy: params.groupPolicy === "allowlist" && !params.channelAllowlistConfigured
            ? "open"
            : params.groupPolicy,
...
export function shouldEmitDiscordReactionNotification(params) {
    ...
    const accessGuildInfo = params.guildInfo ??
        (params.allowlist ? { users: params.allowlist } : null);
