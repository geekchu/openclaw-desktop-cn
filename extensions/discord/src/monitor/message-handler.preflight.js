...
import { buildMentionRegexes, logInboundDrop, matchesMentionWithExplicit, resolveMentionGatingWithBypass, } from "openclaw/plugin-sdk/channel-inbound";
...
import { isDiscordGroupAllowedByPolicy, normalizeDiscordSlug, resolveDiscordChannelConfigWithFallback, resolveDiscordGuildEntry, resolveDiscordMemberAccessState, resolveDiscordOwnerAccess, resolveDiscordShouldRequireMention, resolveGroupDmAllow, } from "./allow-list.js";
...
import { buildDiscordRoutePeer, resolveDiscordConversationRoute, resolveDiscordEffectiveRoute, } from "./route-resolution.js";
...
function mergeFetchedDiscordMessage(base, fetched) {
    ...
    const rawData = {
        ...
        message_snapshots: fetched.message_snapshots ??
            base.rawData?.message_snapshots,
        sticker_items: fetched.sticker_items ??
            base.rawData?.sticker_items,
    };
    return {
        ...base,
        ...fetched,
        ...
        stickers: fetched.stickers ??
            fetched.sticker_items ??
            base.stickers,
...
export async function preflightDiscordMessage(params) {
    ...
    const configuredRoute = threadBinding == null
    ...
    const hasUserOrRoleMention = Boolean(!isDirectMessage &&
