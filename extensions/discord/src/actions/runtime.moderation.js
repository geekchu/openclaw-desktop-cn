import { jsonResult, readStringParam, } from "../runtime-api.js";
import { banMemberDiscord, hasAnyGuildPermissionDiscord, kickMemberDiscord, timeoutMemberDiscord, } from "../send.js";
import { isDiscordModerationAction, readDiscordModerationCommand, requiredGuildPermissionForModerationAction, } from "./runtime.moderation-shared.js";
...
async function verifySenderModerationPermission(params) {
    ...
    const hasPermission = await discordModerationActionRuntime.hasAnyGuildPermissionDiscord(params.guildId, params.senderUserId, [params.requiredPermission], params.accountId ? { accountId: params.accountId } : undefined);
    if (!hasPermission) {
