import { evaluateSenderGroupAccessForPolicy, isDangerousNameMatchingEnabled, resolveAllowlistMatchSimple, resolveControlCommandGate, resolveEffectiveAllowFromLists, } from "./runtime-api.js";
export function normalizeMattermostAllowEntry(entry) {
...
export function normalizeMattermostAllowList(entries) {
...
export function authorizeMattermostCommandInvocation(params) {
    ...
    const commandGroupAllowFrom = kind === "direct"
    ...
    const commandAuthorized = kind === "direct"
