...
import { createMattermostClient, fetchMattermostChannel, sendMattermostTyping, } from "./client.js";
import { renderMattermostModelSummaryView, renderMattermostModelsPickerView, renderMattermostProviderPickerView, resolveMattermostModelPickerCurrentModel, resolveMattermostModelPickerEntry, } from "./model-picker.js";
import { authorizeMattermostCommandInvocation, normalizeMattermostAllowList, } from "./monitor-auth.js";
import { deliverMattermostReplyPayload } from "./reply-delivery.js";
import { buildModelsProviderData, createChannelReplyPipeline, isRequestBodyLimitError, logTypingFailure, readRequestBodyWithLimit, } from "./runtime-api.js";
import { sendMessageMattermost } from "./send.js";
import { parseSlashCommandPayload, resolveCommandText, } from "./slash-commands.js";
...
async function authorizeSlashInvocation(params) {
    ...
    const storeAllowFrom = normalizeMattermostAllowList(await core.channel.pairing
        .readAllowFromStore({
        channel: "mattermost",
    ...
    if (!decision.ok) {
        ...
        const denyText = decision.denyReason === "unknown-channel"
 ...
 */
export function createSlashCommandHttpHandler(params) {
...
async function handleSlashCommandAsync(params) {
    ...
    if (pickerEntry) {
        ...
        const view = pickerEntry.kind === "summary"
