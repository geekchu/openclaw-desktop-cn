...
export function resolveSlashHandlerForToken(token) {
    const matches = [];
 ...
 */
export function getSlashCommandState(accountId) {
    return accountStates.get(accountId) ?? null;
}
/**
 * Get all active slash command account states.
 */
export function getAllSlashCommandStates() {
 ...
 */
export function deactivateSlashCommands(accountId) {
    if (accountId) {
 ...
 */
export function registerSlashCommandRoute(api) {
