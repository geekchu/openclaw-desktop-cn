...
import { applyAccountNameToChannelSection, applySetupAccountConfigPatch, DEFAULT_ACCOUNT_ID, migrateBaseNameToDefaultAccount, normalizeAccountId, } from "./runtime-api.js";
import { hasConfiguredSecretInput } from "./secret-input.js";
const channel = "mattermost";
export function isMattermostConfigured(account) {
...
export function resolveMattermostAccountWithSecrets(cfg, accountId) {
...
export const mattermostSetupAdapter = {
