...
import { resolveVisibleWhatsAppGroupHistory, resolveVisibleWhatsAppReplyContext, } from "./inbound-context.js";
import { buildWhatsAppInboundContext, dispatchWhatsAppBufferedReply, resolveWhatsAppDmRouteTarget, resolveWhatsAppResponsePrefix, updateWhatsAppMainLastRoute, } from "./inbound-dispatch.js";
import { trackBackgroundTask, updateLastRouteInBackground } from "./last-route.js";
import { buildInboundLine } from "./message-line.js";
import { buildHistoryContextFromEntries, createChannelReplyPipeline, formatInboundEnvelope, logVerbose, normalizeE164, readStoreAllowFromForDmPolicy, recordSessionMetaFromInbound, resolveChannelContextVisibilityMode, resolveInboundSessionEnvelopeContext, resolvePinnedMainDmOwnerFromAllowlist, resolveDmGroupAccessWithCommandGate, shouldComputeCommandAuthorized, shouldLogVerbose, } from "./runtime-api.js";
async function resolveWhatsAppCommandAuthorized(params) {
    ...
    const dmAllowFrom = configuredAllowFrom.length > 0 ? configuredAllowFrom : self.e164 ? [self.e164] : [];
...
export async function processMessage(params) {
    ...
    const visibleGroupHistory = params.msg.chatType === "group"
