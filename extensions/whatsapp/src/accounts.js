...
import { createAccountListHelpers, DEFAULT_ACCOUNT_ID, normalizeAccountId, resolveAccountEntry, resolveMergedAccountConfig, resolveUserPath, } from "openclaw/plugin-sdk/account-core";
...
export function resolveWhatsAppMediaMaxBytes(account) {
    const mediaMaxMb = typeof account.mediaMaxMb === "number" && account.mediaMaxMb > 0
        ? account.mediaMaxMb
