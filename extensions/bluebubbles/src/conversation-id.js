import { extractHandleFromChatGuid, normalizeBlueBubblesHandle, parseBlueBubblesTarget, } from "./targets.js";
export function normalizeBlueBubblesAcpConversationId(conversationId) {
...
export function resolveBlueBubblesInboundConversationId(params) {
    ...
    const normalized = (params.chatGuid && normalizeBlueBubblesAcpConversationId(params.chatGuid)?.conversationId) ||
...
export function resolveBlueBubblesConversationIdFromTarget(target) {
