 ...
 */
export async function fetchBlueBubblesHistory(chatIdentifier, limit, opts = {}) {
    ...
    for (const path of possiblePaths) {
        try {
            ...
            const res = await blueBubblesFetchWithTimeout(url, { method: "GET" }, opts.timeoutMs ?? 10000, ssrfPolicy);
            if (!res.ok) {
