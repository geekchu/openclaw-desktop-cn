import { buildSingleChannelSecretPromptState, createTopLevelChannelDmPolicy, createStandardChannelSetupStatus, DEFAULT_ACCOUNT_ID, formatDocsLink, hasConfiguredSecretInput, mergeAllowFromEntries, normalizeAccountId, promptSingleChannelSecretInput, runSingleChannelSecretStep, } from "openclaw/plugin-sdk/setup";
...
export const zaloSetupWizard = {
    ...
    finalize: async ({ cfg, accountId, forceAllowFrom, options, prompter }) => {
        ...
        if (wantsWebhook) {
            ...
            while (webhookSecretResult.action === "set" &&
            ...
            const webhookSecret = webhookSecretResult.action === "set"
            ...
            next = setZaloUpdateMode(next, accountId, "webhook", webhookUrl, webhookSecret, webhookPath || undefined);
        }
        else {
