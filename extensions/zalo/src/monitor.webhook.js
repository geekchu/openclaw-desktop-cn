...
import { createDedupeCache, createFixedWindowRateLimiter, createWebhookAnomalyTracker, readJsonWebhookBodyOrReject, applyBasicWebhookRequestGuards, registerWebhookTargetWithPluginRoute, registerWebhookTarget, resolveWebhookTargetWithAuthOrRejectSync, withResolvedWebhookRequestPipeline, WEBHOOK_ANOMALY_COUNTER_DEFAULTS, WEBHOOK_RATE_LIMIT_DEFAULTS, resolveClientIp, } from "./runtime-api.js";
...
export function clearZaloWebhookSecurityStateForTest() {
    webhookRateLimiter.clear();
    webhookAnomalyTracker.clear();
}
export function getZaloWebhookRateLimitStateSizeForTest() {
    return webhookRateLimiter.size();
}
export function getZaloWebhookStatusCounterSizeForTest() {
...
export function registerZaloWebhookTarget(target, opts) {
    if (opts?.route) {
...
export async function handleZaloWebhookRequest(req, res, processUpdate) {
