...
import { buildChannelConfigSchema, buildTokenChannelStatusSummary, DEFAULT_ACCOUNT_ID, chunkTextForOutbound, formatAllowFromLowercase, isNumericTargetId, sendPayloadWithChunkedTextAndMedia, } from "./runtime-api.js";
...
export const zaloPlugin = createChatChannelPlugin({
    base: {
        id: "zalo",
        meta,
        ...
        status: createComputedAccountStatusAdapter({
            ...
            probeAccount: async ({ account, timeoutMs }) => await (await loadZaloChannelRuntime()).probeZaloAccount({ account, timeoutMs }),
        ...
        gateway: {
            startAccount: async (ctx) => await (await loadZaloChannelRuntime()).startZaloGatewayAccount(ctx),
        },
    },
    security: {
