import { addWildcardAllowFrom, createDelegatedSetupWizardProxy, createPatchedAccountSetupAdapter, createSetupInputPresenceValidator, DEFAULT_ACCOUNT_ID, normalizeAccountId, } from "openclaw/plugin-sdk/setup";
...
export const zaloDmPolicy = {
    ...
    setPolicy: (cfg, policy, accountId) => {
        const resolvedAccountId = accountId && normalizeAccountId(accountId)
...
export function createZaloSetupWizardProxy(loadWizard) {
