import { createAllowFromSection, createStandardChannelSetupStatus, createTopLevelChannelDmPolicy, } from "openclaw/plugin-sdk/setup";
import { isLineConfigured, listLineAccountIds, parseLineAllowFromId, patchLineAccountConfig, } from "./setup-core.js";
import { DEFAULT_ACCOUNT_ID, formatDocsLink, resolveLineAccount, setSetupChannelEnabled, splitSetupEntries, } from "./setup-runtime-api.js";
const channel = "line";
