import { formatInboundEnvelope, formatLocationText, resolveInboundSessionEnvelopeContext, toLocationContext, } from "openclaw/plugin-sdk/channel-inbound";
...
export async function buildLineMessageContext(params) {
    ...
    const inboundHistory = historyKey && groupHistories && (historyLimit ?? 0) > 0
