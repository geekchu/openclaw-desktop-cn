...
import { danger, DEFAULT_UPLOAD_DIR, defaultRuntime, resolveExistingPathsWithinRoot, shortenHomePath, } from "../core-api.js";
...
export function registerBrowserFilesAndDownloadsCommands(browser, parentOpts) {
    ...
    browser
        ...
        .argument("<paths...>", "File paths to upload (must be within OpenClaw temp uploads dir, e.g. /tmp/openclaw/uploads/file.pdf)")
    ...
    browser
        ...
        .argument("[path]", "Save path within openclaw temp downloads dir (default: /tmp/openclaw/downloads/...; fallback: os.tmpdir()/openclaw/downloads/...)")
        .option("--target-id <id>", "CDP target id (or unique prefix)")
    ...
    browser
        ...
        .argument("<path>", "Save path within openclaw temp downloads dir (e.g. report.pdf or /tmp/openclaw/downloads/report.pdf)")
        .option("--target-id <id>", "CDP target id (or unique prefix)")
