...
import { resolveDefaultSnapshotFormat, shouldUsePlaywrightForAriaSnapshot, shouldUsePlaywrightForScreenshot, } from "../profile-capabilities.js";
...
export function resolveSnapshotPlan(params) {
    ...
    const explicitFormat = params.query.format === "aria" ? "aria" : params.query.format === "ai" ? "ai" : undefined;
    ...
    const maxCharsRaw = typeof params.query.maxChars === "string" ? Number(params.query.maxChars) : undefined;
