...
import { DEFAULT_UPLOAD_DIR, applyBrowserProxyPaths, browserAct, browserArmDialog, browserArmFileChooser, browserCloseTab, browserFocusTab, browserNavigate, browserOpenTab, browserPdfSave, browserProfiles, browserScreenshotAction, browserStart, browserStatus, browserStop, getBrowserProfileCapabilities, imageResultFromFile, jsonResult, listNodes, loadConfig, persistBrowserProxyFiles, readStringParam, resolveBrowserConfig, resolveExistingPathsWithinRoot, resolveNodeIdFromList, resolveProfile, selectDefaultNodeFromList, trackSessionBrowserTab, untrackSessionBrowserTab, } from "./core-api.js";
...
async function callBrowserProxy(params) {
    const proxyTimeoutMs = typeof params.timeoutMs === "number" && Number.isFinite(params.timeoutMs)
...
function resolveBrowserBaseUrl(params) {
    ...
    if (!resolved.enabled) {
        throw new Error("Browser control is disabled. Set browser.enabled=true in ~/.openclawcn/openclaw.json.");
    }
    return undefined;
}
