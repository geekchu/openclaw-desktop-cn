...
- Install to `~/.openclawcn/extensions/`
- Update your OpenClaw configuration
- Register the plugin

## Configuration

Add to your OpenClaw configuration file (`~/.openclawcn/openclaw.json`):
...
- **Local images** (from `~/.openclawcn/media/`) are automatically encoded to base64 and sent via WeCom's `msg_item` API
