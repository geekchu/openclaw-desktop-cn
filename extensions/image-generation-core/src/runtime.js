import { createSubsystemLogger, describeFailoverError, getImageGenerationProvider, getProviderEnvVars, isFailoverError, listImageGenerationProviders, parseImageGenerationModelRef, resolveAgentModelFallbackValues, resolveAgentModelPrimaryValue, } from "../api.js";
...
function resolveImageGenerationCandidates(params) {
    ...
    for (const fallback of resolveAgentModelFallbackValues(params.cfg.agents?.defaults?.imageGenerationModel)) {
        add(fallback);
    }
    return candidates;
}
