...
import { buildMentionRegexes, createChannelInboundDebouncer, formatInboundEnvelope, formatInboundFromLabel, matchesMentionPatterns, resolveEnvelopeFormatOptions, shouldDebounceTextInbound, } from "openclaw/plugin-sdk/channel-inbound";
import { logInboundDrop, resolveMentionGatingWithBypass, } from "openclaw/plugin-sdk/channel-inbound";
...
import { DM_GROUP_ACCESS_REASON, resolvePinnedMainDmOwnerFromAllowlist, } from "openclaw/plugin-sdk/security-runtime";
import { normalizeE164 } from "openclaw/plugin-sdk/text-runtime";
import { formatSignalPairingIdLine, formatSignalSenderDisplay, formatSignalSenderId, isSignalSenderAllowed, normalizeSignalAllowRecipient, resolveSignalPeerId, resolveSignalRecipient, resolveSignalSender, } from "../identity.js";
    ...
    return async (event) => {
        ...
        if (isGroup && requireMention && canDetectMention && mentionGate.shouldSkip) {
            ...
            const pendingPlaceholder = (() => {
                ...
                const attachmentTypes = (dataMessage.attachments ?? []).map((attachment) => typeof attachment?.contentType === "string" ? attachment.contentType : undefined);
