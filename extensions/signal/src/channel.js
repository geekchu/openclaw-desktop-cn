...
import { buildBaseChannelStatusSummary, chunkText, collectStatusIssuesFromLastError, createDefaultChannelRuntimeState, DEFAULT_ACCOUNT_ID, PAIRING_APPROVED_MESSAGE, resolveChannelMediaMaxBytes, } from "./runtime-api.js";
import { getSignalRuntime } from "./runtime.js";
import { signalSetupAdapter } from "./setup-core.js";
import { signalConfigAdapter, createSignalPluginBase, signalSecurityAdapter, signalSetupWizard, } from "./shared.js";
...
export const signalPlugin = createChatChannelPlugin({
    base: {
        ...
        allowlist: buildDmGroupAccountAllowlistAdapter({
            ...
            normalize: ({ cfg, accountId, values }) => signalConfigAdapter.formatAllowFrom({ cfg, accountId, allowFrom: values }),
        ...
        status: createComputedAccountStatusAdapter({
            ...
            formatCapabilitiesProbe: ({ probe }) => probe?.version
