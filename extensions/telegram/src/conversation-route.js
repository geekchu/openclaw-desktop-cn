...
import { buildAgentSessionKey, deriveLastRoutePolicy, resolveAgentRoute, } from "openclaw/plugin-sdk/routing";
...
export function resolveTelegramConversationRoute(params) {
    ...
    if (threadBindingConversationId) {
        ...
        if (threadBinding && boundSessionKey) {
            ...
            logVerbose(isPluginOwnedSessionBindingRecord(threadBinding)
...
export function resolveTelegramConversationBaseSessionKey(params) {
    const isNamedAccountFallback = params.route.accountId !== DEFAULT_ACCOUNT_ID && params.route.matchedBy === "default";
