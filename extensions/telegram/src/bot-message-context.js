...
import { createStatusReactionController, shouldAckReaction as shouldAckReactionGate, } from "openclaw/plugin-sdk/channel-feedback";
...
import { buildTypingThreadParams, extractTelegramForumFlag, resolveTelegramForumFlag, resolveTelegramThreadSpec, } from "./bot/helpers.js";
...
import { buildTelegramStatusReactionVariants, isTelegramSupportedReactionEmoji, resolveTelegramAllowedEmojiReactions, resolveTelegramReactionVariant, resolveTelegramStatusReactionEmojis, } from "./status-reaction-variants.js";
export const buildTelegramMessageContext = async ({ primaryCtx, allMedia, replyMedia = [], storeAllowFrom, options, bot, cfg, account, historyLimit, groupHistories, dmPolicy, allowFrom, groupAllowFrom, ackReactionScope, logger, resolveGroupActivation, resolveGroupRequireMention, resolveTelegramGroupConfig, loadFreshConfig, upsertPairingRequest, sendChatActionHandler, }) => {
    ...
    const reactionApi = typeof bot.api.setMessageReaction === "function"
        ? bot.api.setMessageReaction.bind(bot.api)
        : null;
    const getChatApi = typeof bot.api.getChat === "function"
    ...
    const ackReactionEmoji = ackReaction && isTelegramSupportedReactionEmoji(ackReaction) ? ackReaction : undefined;
    ...
    const ackReactionPromise = statusReactionController
        ...
        : shouldAckReaction() && msg.message_id && reactionApi && ackReactionEmoji
            ? withTelegramApiErrorLogging({
                ...
                fn: () => reactionApi(chatId, msg.message_id, [{ type: "emoji", emoji: ackReactionEmoji }]),
            }).then(() => true, (err) => {
