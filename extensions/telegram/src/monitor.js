...
import { isRecoverableTelegramNetworkError, isTelegramPollingNetworkError, } from "./network-errors.js";
...
export async function monitorTelegramProvider(opts = {}) {
    ...
    try {
        ...
        const createTelegramTransportForPolling = () => resolveTelegramTransport(proxyFetch, {
