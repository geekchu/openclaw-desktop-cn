...
export const telegramOutbound = {
    ...
    ...createAttachedChannelResultAdapter({
        ...
        sendMedia: async ({ cfg, to, text, mediaUrl, mediaLocalRoots, accountId, deps, replyToId, threadId, forceDocument, gatewayClientScopes, }) => {
            const { send, baseOpts } = resolveTelegramSendContext({
                cfg,
                deps,
                accountId,
    ...
    sendPayload: async ({ cfg, to, payload, mediaLocalRoots, accountId, deps, replyToId, threadId, forceDocument, gatewayClientScopes, }) => {
        const { send, baseOpts } = resolveTelegramSendContext({
            cfg,
            deps,
            accountId,
