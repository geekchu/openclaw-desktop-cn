...
import { normalizeTelegramCommandName, TELEGRAM_COMMAND_NAME_PATTERN, } from "openclaw/plugin-sdk/config-runtime";
...
function formatTelegramCommandRetrySuccessLog(params) {
    ...
    return (`Telegram accepted ${params.acceptedCount} commands after BOT_COMMANDS_TOO_MUCH ` +
...
export function hashCommandList(commands) {
