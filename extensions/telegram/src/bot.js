...
import { resolveThreadBindingIdleTimeoutMsForChannel, resolveThreadBindingMaxAgeMsForChannel, resolveThreadBindingSpawnPolicy, } from "openclaw/plugin-sdk/conversation-runtime";
...
export function setTelegramBotRuntimeForTest(runtime) {
...
export function createTelegramBot(opts) {
    ...
    const telegramTransport = opts.telegramTransport ??
    ...
    if (finalFetch || opts.fetchAbortSignal) {
        ...
        finalFetch = (input, init) => {
            ...
            const requestTimeoutMs = method === "getupdates" ? TELEGRAM_GET_UPDATES_REQUEST_TIMEOUT_MS : undefined;
            let requestTimeout;
            let onRequestAbort;
