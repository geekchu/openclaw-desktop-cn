...
import { jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections, } from "../runtime-api.js";
import { createTelegramActionGate, resolveTelegramPollActionGateState } from "./accounts.js";
import { resolveTelegramInlineButtons } from "./button-types.js";
import { resolveTelegramInlineButtonsScope, resolveTelegramTargetChatType, } from "./inline-buttons.js";
...
function readTelegramThreadId(params) {
    return (readNumberParam(params, "messageThreadId", { integer: true }) ??
        readNumberParam(params, "threadId", { integer: true }));
}
function readTelegramReplyToMessageId(params) {
    return (readNumberParam(params, "replyToMessageId", { integer: true }) ??
...
function readTelegramSendContent(params) {
    const content = readStringParam(params.args, "content", { allowEmpty: true }) ??
...
export async function handleTelegramAction(params, cfg, options) {
    ...
    if (action === "editMessage") {
        ...
        const content = readStringParam(params, "content", { allowEmpty: false }) ??
