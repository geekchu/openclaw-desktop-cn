...
export const MODELSTUDIO_STANDARD_GLOBAL_BASE_URL = "https://dashscope-intl.aliyuncs.com/compatible-mode/v1";
...
export const MODELSTUDIO_MODEL_CATALOG = [
    {
        id: "qwen3.5-plus",
        name: "qwen3.5-plus",
        reasoning: false,
...
export function isNativeModelStudioBaseUrl(baseUrl) {
    const normalized = normalizeModelStudioBaseUrl(baseUrl);
    return (normalized === MODELSTUDIO_BASE_URL ||
...
export function applyModelStudioNativeStreamingUsageCompat(provider) {
...
export function buildModelStudioDefaultModelDefinition() {
