...
import { isInboundPathAllowed, resolveIMessageAttachmentRoots, resolveIMessageRemoteAttachmentRoots, } from "openclaw/plugin-sdk/media-runtime";
import { kindFromMime } from "openclaw/plugin-sdk/media-runtime";
import { clearHistoryEntriesIfEnabled, DEFAULT_GROUP_HISTORY_LIMIT, } from "openclaw/plugin-sdk/reply-history";
...
export async function monitorIMessageProvider(opts = {}) {
    ...
    async function handleMessageNow(message) {
        ...
        if (decision.kind === "drop") {
            ...
            const isLoopDrop = decision.reason === "echo" ||
