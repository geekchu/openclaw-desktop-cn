...
import { createAllowedChatSenderMatcher, parseChatTargetPrefixesOrThrow, resolveServicePrefixedChatTarget, resolveServicePrefixedOrChatAllowTarget, } from "./target-parsing-helpers.js";
...
export function looksLikeIMessageExplicitTargetId(raw) {
    const trimmed = raw.trim();
    if (!trimmed) {
        return false;
    }
