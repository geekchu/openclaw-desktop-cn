...
export async function promptIMessageAllowFrom(params) {
    return promptParsedAllowFromForAccount({
        ...
        getExistingAllowFrom: ({ cfg, accountId }) => resolveIMessageAccount({ cfg, accountId }).config.allowFrom ?? [],
...
export function createIMessageCliPathTextInput(shouldPrompt) {
...
export const imessageSetupAdapter = createPatchedAccountSetupAdapter({
    channelKey: channel,
...
export function createIMessageSetupWizardProxy(loadWizard) {
    return createDelegatedSetupWizardProxy({
        ...
        credentials: [],
        textInputs: [
            createIMessageCliPathTextInput(createDelegatedTextInputShouldPrompt({
                loadWizard,
                inputKey: "cliPath",
            })),
        ],
