...
export declare const FeishuDriveSchema: import("@sinclair/typebox").TUnion<
  [
    ...
    import("@sinclair/typebox").TObject<{
      ...
      type: import("@sinclair/typebox").TUnion<
        [
          import("@sinclair/typebox").TLiteral<"doc">,
          import("@sinclair/typebox").TLiteral<"docx">,
          import("@sinclair/typebox").TLiteral<"sheet">,
          import("@sinclair/typebox").TLiteral<"bitable">,
          import("@sinclair/typebox").TLiteral<"folder">,
          import("@sinclair/typebox").TLiteral<"file">,
          import("@sinclair/typebox").TLiteral<"mindnote">,
          import("@sinclair/typebox").TLiteral<"shortcut">,
        ]
      >;
    }>,
    import("@sinclair/typebox").TObject<{
    ...
    import("@sinclair/typebox").TObject<{
      ...
      file_token: import("@sinclair/typebox").TString;
      file_type: import("@sinclair/typebox").TOptional<
        import("@sinclair/typebox").TUnion<
          [
            ...
            import("@sinclair/typebox").TLiteral<"sheet">,
            import("@sinclair/typebox").TLiteral<"file">,
            import("@sinclair/typebox").TLiteral<"slides">,
          ]
        >
      >;
