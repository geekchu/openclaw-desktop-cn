...
export async function getChatMembers(client, chatId, pageSize, pageToken, memberIdType) {
...
export async function getFeishuMemberInfo(client, memberId, memberIdType = "open_id") {
