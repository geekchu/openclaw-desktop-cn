import { buildSingleChannelSecretPromptState, createTopLevelChannelAllowFromSetter, createTopLevelChannelDmPolicy, createTopLevelChannelGroupPolicySetter, createTopLevelChannelParsedAllowFromPrompt, DEFAULT_ACCOUNT_ID, formatDocsLink, hasConfiguredSecretInput, mergeAllowFromEntries, patchTopLevelChannelConfigSection, promptSingleChannelSecretInput, splitSetupEntries, } from "openclaw/plugin-sdk/setup";
...
const feishuDmPolicy = createTopLevelChannelDmPolicy({
    label: "Feishu",
    channel,
...
export const feishuSetupWizard = {
    channel,
    ...
    finalize: async ({ cfg, prompter, options }) => {
        ...
        if (connectionMode === "webhook") {
            const currentVerificationToken = next.channels?.feishu
                ?.verificationToken;
