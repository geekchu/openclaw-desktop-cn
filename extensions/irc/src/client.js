...
export function buildIrcNickServCommands(options) {
...
export async function connectIrcClient(options) {
        ...
        while (idx !== -1) {
            ...
            if (line.command === "PRIVMSG") {
                ...
                if (options.onPrivmsg) {
                    void Promise.resolve(options.onPrivmsg({
                        senderNick,
