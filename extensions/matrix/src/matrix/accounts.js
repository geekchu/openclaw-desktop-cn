...
import { resolveConfiguredMatrixAccountIds, resolveMatrixDefaultOrOnlyAccountId, } from "../account-selection.js";
import { DEFAULT_ACCOUNT_ID, hasConfiguredSecretInput, normalizeAccountId, } from "../runtime-api.js";
...
export function resolveMatrixAccount(params) {
    ...
    const explicitAuthConfig = accountId === DEFAULT_ACCOUNT_ID
        ? base
    ...
    const hasStored = stored && resolved.homeserver
