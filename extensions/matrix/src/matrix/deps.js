...
export async function ensureMatrixCryptoRuntime(params = {}) {
...
export async function ensureMatrixSdkInstalled(params) {
    ...
    if (confirm) {
        const ok = await confirm("Matrix requires matrix-js-sdk and @matrix-org/matrix-sdk-crypto-nodejs. Install now?");
        if (!ok) {
            throw new Error("Matrix requires matrix-js-sdk and @matrix-org/matrix-sdk-crypto-nodejs (install dependencies first).");
        }
    }
