...
export declare function listMatrixVerifications(opts?: MatrixActionClientOpts): Promise<import("../sdk/verification-manager.js").MatrixVerificationSummary[]>;
export declare function requestMatrixVerification(params?: MatrixActionClientOpts & {
    ownUser?: boolean;
    userId?: string;
    deviceId?: string;
    roomId?: string;
}): Promise<import("../sdk/verification-manager.js").MatrixVerificationSummary>;
export declare function acceptMatrixVerification(requestId: string, opts?: MatrixActionClientOpts): Promise<import("../sdk/verification-manager.js").MatrixVerificationSummary>;
...
export declare function scanMatrixVerificationQr(requestId: string, qrDataBase64: string, opts?: MatrixActionClientOpts): Promise<import("../sdk/verification-manager.js").MatrixVerificationSummary>;
export declare function getMatrixVerificationSas(requestId: string, opts?: MatrixActionClientOpts): Promise<{
    decimal?: [number, number, number];
    emoji?: Array<[string, string]>;
}>;
export declare function confirmMatrixVerificationSas(requestId: string, opts?: MatrixActionClientOpts): Promise<import("../sdk/verification-manager.js").MatrixVerificationSummary>;
export declare function mismatchMatrixVerificationSas(requestId: string, opts?: MatrixActionClientOpts): Promise<import("../sdk/verification-manager.js").MatrixVerificationSummary>;
export declare function confirmMatrixVerificationReciprocateQr(requestId: string, opts?: MatrixActionClientOpts): Promise<import("../sdk/verification-manager.js").MatrixVerificationSummary>;
