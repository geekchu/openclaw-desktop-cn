...
import { computeBackoff, createNonExitingRuntime, sleepWithAbort, } from "openclaw/plugin-sdk/runtime-env";
...
import { formatUnknownError, getSocketEmitter, isNonRecoverableSlackAuthError, SLACK_SOCKET_RECONNECT_POLICY, waitForSlackSocketDisconnect, } from "./reconnect-policy.js";
...
function resolveSlackBoltInterop(params) {
    ...
    const nestedDefault = defaultImport && typeof defaultImport === "object"
        ? Reflect.get(defaultImport, "default")
        : undefined;
    const namespaceDefault = namespaceImport && typeof namespaceImport === "object"
        ? Reflect.get(namespaceImport, "default")
        : undefined;
    const namespaceReceiver = namespaceImport && typeof namespaceImport === "object"
        ? Reflect.get(namespaceImport, "HTTPReceiver")
        : undefined;
    const directModule = resolveSlackBoltModule(defaultImport) ??
    ...
    if (isConstructorFunction(defaultImport) &&
