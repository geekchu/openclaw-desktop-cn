...
import { buildMentionRegexes, formatInboundEnvelope, logInboundDrop, matchesMentionWithExplicit, resolveEnvelopeFormatOptions, resolveMentionGatingWithBypass, } from "openclaw/plugin-sdk/channel-inbound";
...
import { recordInboundSession, resolveConversationLabel, } from "openclaw/plugin-sdk/conversation-runtime";
...
export async function prepareSlackMessage(params) {
    ...
    const threadStarter = isThreadReply && threadTs
