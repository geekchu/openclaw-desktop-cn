...
export function resolveSlackChannelConfig(params) {
    ...
    const candidates = buildChannelKeyCandidates(channelId, channelIdLower !== channelId ? channelIdLower : undefined, channelIdUpper !== channelId ? channelIdUpper : undefined, allowNameMatching ? (channelName ? `#${directName}` : undefined) : undefined, allowNameMatching ? directName : undefined, allowNameMatching ? normalizedName : undefined);
