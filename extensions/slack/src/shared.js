...
import { formatDocsLink, hasConfiguredSecretInput, patchChannelConfigForAccount, } from "openclaw/plugin-sdk/setup";
import { inspectSlackAccount } from "./account-inspect.js";
import { listSlackAccountIds, resolveDefaultSlackAccountId, resolveSlackAccount, } from "./accounts.js";
...
export function buildSlackSetupLines(botName = "OpenClaw") {
    return [
...
export function setSlackChannelAllowlist(cfg, accountId, channelKeys) {
...
export function isSlackPluginAccountConfigured(account) {
...
export function isSlackSetupAccountConfigured(account) {
