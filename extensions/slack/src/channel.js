...
import { DEFAULT_ACCOUNT_ID, looksLikeSlackTargetId, normalizeSlackMessagingTarget, PAIRING_APPROVED_MESSAGE, projectCredentialSnapshotFields, resolveConfiguredFromRequiredCredentialStatuses, } from "./runtime-api.js";
import { getSlackRuntime } from "./runtime.js";
import { fetchSlackScopes } from "./scopes.js";
import { slackSetupAdapter } from "./setup-core.js";
import { slackSetupWizard } from "./setup-surface.js";
import { createSlackPluginBase, isSlackPluginAccountConfigured, slackConfigAdapter, SLACK_CHANNEL, } from "./shared.js";
...
export const slackPlugin = createChatChannelPlugin({
    base: {
        ...
        allowlist: {
            ...buildLegacyDmAccountAllowlistAdapter({
                channelId: "slack",
                resolveAccount: resolveSlackAccount,
                normalize: ({ cfg, accountId, values }) => slackConfigAdapter.formatAllowFrom({ cfg, accountId, allowFrom: values }),
    ...
    threading: {
        ...
        resolveAutoThreadId: ({ to, toolContext, replyToId }) => replyToId
            ? undefined
