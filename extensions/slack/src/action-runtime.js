...
import { createActionGate, imageResultFromFile, jsonResult, readNumberParam, readReactionParams, readStringParam, withNormalizedTimestamp, } from "./runtime-api.js";
        ...
        switch (action) {
            case "sendMessage": {
                ...
                if (threadTs && result.channelId && account.accountId) {
                    slackActionRuntime.recordSlackThreadParticipation(account.accountId, result.channelId, threadTs);
                }
