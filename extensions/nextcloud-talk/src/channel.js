...
import { buildChannelConfigSchema, clearAccountEntryFields, DEFAULT_ACCOUNT_ID, } from "../runtime-api.js";
import { listNextcloudTalkAccountIds, resolveDefaultNextcloudTalkAccountId, resolveNextcloudTalkAccount, } from "./accounts.js";
...
const collectNextcloudTalkSecurityWarnings = createAllowlistProviderRouteAllowlistWarningCollector({
    providerConfigPresent: (cfg) => cfg.channels?.["nextcloud-talk"] !== undefined,
...
export const nextcloudTalkPlugin = createChatChannelPlugin({
    base: {
        id: "nextcloud-talk",
        meta,
