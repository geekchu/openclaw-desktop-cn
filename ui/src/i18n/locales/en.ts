...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    terminal: "Access and control the underlying terminal environment.",
    onestop: "Configure and manage AI model integration settings.",
    messages: "Manage message-related configuration and settings.",
    systemSettings: "Configure system-level settings and parameters.",
  },
  configSections: {
    core: "Core",
    aiAgents: "AI & Agents",
