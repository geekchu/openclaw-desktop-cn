...
export const zh_CN: TranslationMap = {
  ...
  subtitles: {
    ...
    onestop: "配置和管理 AI 大模型接入设置。",
    messages: "管理消息相关的配置和设置。",
    systemSettings: "配置系统级别的设置和参数。",
  },
  configSections: {
    core: "核心",
    aiAgents: "AI 与代理",
  ...
  usage: {
    ...
    empty: {
      title: "从日期范围开始",
      subtitle: "加载使用数据以比较成本、检查会话并深入时间线，无需离开仪表板。",
    ...
    overview: {
      ...
      avgCost: "平均费用 / 消息",
      avgCostHint: "当提供商报告费用时，每条消息的平均费用。",
      avgCostHintMissing: "当提供商报告费用时，每条消息的平均费用。此范围内的部分或全部会话缺少费用数据。",
      acrossMessages: "跨 {count} 条消息",
      sessions: "会话",
      sessionsHint: "范围内的不同会话。",
      sessionsInRange: "/ {count} 个在范围内",
      throughput: "吞吐量",
      throughputHint: "吞吐量显示活动时间内每分钟的令牌数。越高越好。",
    ...
    details: {
      ...
      usageOverTime: "随时间的使用情况",
      reset: "重置",
      perTurn: "每轮",
      cumulative: "累计",
      turnRange: "轮次 {start}–{end} / 共 {total}",
    ...
    mosaic: {
      ...
      subtitle: "从会话跨度（首次/最后活动）估算。时区：{zone}。",
