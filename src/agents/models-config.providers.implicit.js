...
import { mergeImplicitAnthropicVertexProvider, resolveImplicitAnthropicVertexProvider, } from "../plugin-sdk/anthropic-vertex.js";
...
const CORE_IMPLICIT_PROVIDER_RESOLVERS = [
    {
        id: "anthropic-vertex",
        resolve: async (params) => resolveImplicitAnthropicVertexProvider({
            env: params.env,
        }),
    },
];
