...
function describeAssistantContentKind(content) {
...
function canonicalizeAssistantHistoryMessages(params) {
    ...
    log.warn(`sanitizeSessionHistory: canonicalized ${repairedCount} malformed assistant message(s) before replay ` +
...
export async function sanitizeSessionHistory(params) {
    ...
    const sanitizedImages = await sanitizeSessionMessagesImages(canonicalizedAssistantHistory, "session:history", {
