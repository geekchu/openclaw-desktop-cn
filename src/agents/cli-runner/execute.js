...
import { appendImagePathsToPrompt, buildCliSupervisorScopeKey, buildCliArgs, enqueueCliRun, loadPromptRefImages, resolveCliNoOutputTimeoutMs, resolvePromptInput, resolveSessionIdToSend, resolveSystemPromptUsage, writeCliImages, } from "./helpers.js";
            ...
            if (result.exitCode !== 0 || result.reason !== "exit") {
                if (result.reason === "no-output-timeout" || result.noOutputTimedOut) {
                    ...
                    if (params.sessionKey) {
                        ...
                        requestHeartbeatNow(scopedHeartbeatWakeOptions(params.sessionKey, { reason: "cli:watchdog:stall" }));
                    }
