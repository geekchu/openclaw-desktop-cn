...
import { createSessionVisibilityGuard, createAgentToAgentPolicy, extractAssistantText, resolveEffectiveSessionToolsVisibility, resolveSessionReference, resolveSessionToolContext, resolveVisibleSessionReference, stripToolMessages, } from "./sessions-helpers.js";
...
export function createSessionsSendTool(opts) {
    return {
        ...
        execute: async (_toolCallId, args) => {
            ...
            runId = start.runId;
            const historyBefore = await gatewayCall({
                method: "chat.history",
            ...
            const reply = latestReply.text && latestReply.fingerprint !== baselineReply.fingerprint
                ? latestReply.text
                : undefined;
