...
const WORKSPACE_STATE_DIRNAME = ".openclawcn";
...
function parseWorkspaceSetupState(raw) {
    try {
        ...
        const legacyCompletedAt = typeof parsed.onboardingCompletedAt === "string" ? parsed.onboardingCompletedAt : undefined;
        return {
...
export async function isWorkspaceSetupCompleted(dir) {
...
export async function ensureAgentWorkspace(params) {
    ...
    if (!state.bootstrapSeededAt && !state.setupCompletedAt && !bootstrapExists) {
        ...
        const legacySetupCompleted = identityContent !== identityTemplate || userContent !== userTemplate || hasUserContent;
