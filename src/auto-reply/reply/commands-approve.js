...
import { isDiscordExecApprovalApprover, isDiscordExecApprovalClientEnabled, } from "../../plugin-sdk/discord-surface.js";
import { isTelegramExecApprovalApprover, isTelegramExecApprovalClientEnabled, } from "../../plugin-sdk/telegram-runtime.js";
...
export const handleApproveCommand = async (params, allowTextCommands) => {
    ...
    if (params.command.channel === "telegram") {
        ...
        if (!isPluginId) {
            if (!isTelegramExecApprovalClientEnabled({ cfg: params.cfg, accountId: params.ctx.AccountId })) {
                return {
