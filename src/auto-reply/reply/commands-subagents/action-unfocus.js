...
import { isDiscordSurface, isMatrixSurface, isTelegramSurface, resolveChannelAccountId, resolveCommandSurfaceChannel, resolveTelegramConversationId, stopWithText, } from "./shared.js";
export async function handleSubagentsUnfocusAction(ctx) {
    ...
    if (!binding) {
        return stopWithText(channel === "discord"
    ...
    return stopWithText(channel === "discord" || channel === "matrix"
        ? "✅ Thread unfocused."
