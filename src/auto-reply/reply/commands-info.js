...
import { buildCommandsMessage, buildCommandsMessagePaginated, buildHelpMessage, buildToolsMessage, } from "../status.js";
...
export const handleToolsCommand = async (params, allowTextCommands) => {
    if (!allowTextCommands) {
        return null;
    }
    ...
    try {
        ...
        const result = resolveEffectiveToolInventory({
            ...
            currentThreadTs: typeof params.ctx.MessageThreadId === "string" ||
