...
export async function initSessionState(params) {
    ...
    const commandTargetSessionKey = ctx.CommandSource === "native" ? ctx.CommandTargetSessionKey?.trim() : undefined;
    ...
    const shouldBypassAcpResetForTrigger = (triggerLower) => shouldUseAcpInPlaceReset &&
