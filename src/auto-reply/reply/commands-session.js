...
import { isDiscordSurface, isMatrixSurface, isTelegramSurface, resolveChannelAccountId, } from "./channel-context.js";
import { rejectNonOwnerCommand, rejectUnauthorizedCommand } from "./command-gates.js";
import { handleAbortTrigger, handleStopCommand } from "./commands-session-abort.js";
import { persistSessionEntry } from "./commands-session-store.js";
import { resolveMatrixConversationId, resolveMatrixParentConversationId, } from "./matrix-context.js";
...
export const handleSessionCommand = async (params, allowTextCommands) => {
    ...
    const telegramBinding = onTelegram && telegramConversationId
        ...
        : null;
    const matrixBinding = onMatrix && matrixConversationId
        ? sessionBindingService.resolveByConversation({
            channel: "matrix",
            accountId,
    ...
    const idleTimeoutMs = onDiscord
        ...
        : resolveSessionBindingDurationMs((onMatrix ? matrixBinding : telegramBinding), "idleTimeoutMs", 24 * 60 * 60 * 1000);
