...
export async function dispatchReplyFromConfig(params) {
    ...
    const shouldRouteToOriginating = Boolean(!isInternalWebchatTurn &&
    ...
    if (pluginOwnedBinding) {
        ...
        const targetedClaimOutcome = hookRunner?.runInboundClaimForPluginOutcome
            ? await hookRunner.runInboundClaimForPluginOutcome(pluginOwnedBinding.pluginId, inboundClaimEvent, inboundClaimContext)
            : (() => {
