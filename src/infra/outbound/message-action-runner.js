...
import { getAgentScopedMediaLocalRoots, getAgentScopedMediaLocalRootsForSources, } from "../../media/local-roots.js";
...
import { hydrateAttachmentParamsForAction, normalizeSandboxMediaList, normalizeSandboxMediaParams, parseButtonsParam, parseCardParam, parseComponentsParam, parseInteractiveParam, readBooleanParam, resolveAttachmentMediaPolicy, } from "./message-action-params.js";
import { prepareOutboundMirrorRoute, resolveAndApplyOutboundThreadId, } from "./message-action-threading.js";
...
async function handlePluginAction(ctx) {
    const { cfg, params, channel, mediaLocalRoots, accountId, dryRun, gateway, input, abortSignal, agentId, } = ctx;
    throwIfAborted(abortSignal);
