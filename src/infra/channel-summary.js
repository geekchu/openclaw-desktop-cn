...
import { buildChannelAccountSnapshot, formatChannelAllowFrom, resolveChannelAccountConfigured, resolveChannelAccountEnabled, } from "../channels/account-summary.js";
...
async function inspectChannelAccount(plugin, cfg, accountId) {
    return (plugin.config.inspectAccount?.(cfg, accountId) ??
