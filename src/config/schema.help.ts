...
export const FIELD_HELP: Record<string, string> = {
  ...
  "meta.version": "Config schema version used by desktop app for migration tracking.",
  ...
  "tools.fs.allowedDirs":
    "Additional absolute directories the agent is allowed to access when workspace-only is enabled.",
  ...
  "agents.defaults.memorySearch.store.path":
    "SQLite index path (default: ~/.openclawcn/memory/{agentId}.sqlite).",
  ...
  "plugins.installs.*.installPath":
    "Resolved install directory (usually ~/.openclawcn/extensions/<id>).",
