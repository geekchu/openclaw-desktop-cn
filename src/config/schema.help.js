...
export const FIELD_HELP = {
    ...
    "tools.fs.allowedDirs": "Additional absolute directories the agent is allowed to access when workspace-only is enabled.",
    ...
    "tools.web.x_search.enabled": "Enable the x_search tool (requires XAI_API_KEY or tools.web.x_search.apiKey).",
    ...
    "tools.web.x_search.inlineCitations": "Keep inline citations from xAI in x_search responses when available (default: false).",
    "tools.web.x_search.maxTurns": "Optional max internal search/tool turns xAI may use per x_search request. Omit to let xAI choose.",
    ...
    "agents.defaults.memorySearch.store.path": "SQLite index path (default: ~/.openclawcn/memory/{agentId}.sqlite).",
    ...
    "plugins.installs.*.installPath": "Resolved install directory (usually ~/.openclawcn/extensions/<id>).",
