...
const TelegramAccountSchemaBase = z.object({
  ...
  network: z.object({
    ...
    dangerouslyAllowPrivateNetwork: z.boolean().optional().describe(
  ...
  webhookUrl: z.string().optional().describe(
  ...
  trustedLocalFileRoots: z.array(z.string()).optional().describe(
...
const DiscordUiSchema = z.object({
  components: z.object({
...
const DiscordAccountSchema = z.object({
  ...
  activityType: z.union([z.literal(0), z.literal(1), z.literal(2), z.literal(3), z.literal(4), z.literal(5)]).optional(),
...
const GoogleChatAccountSchema = z.object({
  ...
  defaultTo: z.string().optional(),
  serviceAccount: z.union([z.string(), z.record(z.string(), z.unknown()), SecretRefSchema]).optional().register(sensitive),
