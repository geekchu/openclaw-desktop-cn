...
import { defineLegacyConfigMigration, ensureRecord, getRecord, mergeMissing, } from "./legacy.shared.js";
    ...
    defineLegacyConfigMigration({
        ...
        apply: (raw, changes) => {
            ...
            for (const [accountId, accountValue] of Object.entries(discordAccounts)) {
                ...
                migrateLegacyTtsConfig(getRecord(voice?.tts), `channels.discord.accounts.${accountId}.voice.tts`, changes);
            }
        },
    }),
    defineLegacyConfigMigration({
