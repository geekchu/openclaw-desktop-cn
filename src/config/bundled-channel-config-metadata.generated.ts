...
const PreviewStreamingModeSchema = {
  type: "string",
  enum: ["off", "partial", "block", "progress"],
};

const PreviewStreamingChunkModeSchema = {
  type: "string",
  enum: ["length", "newline"],
};

const PreviewStreamingChunkSchema = {
  type: "object",
  properties: {
    minChars: {
      type: "integer",
...
const PreviewStreamingCoalesceSchema = {
  type: "object",
  properties: {
    minChars: {
      type: "integer",
...
const PreviewStreamingConfigSchema = {
  anyOf: [
    {
      type: "object",
      properties: {
        mode: PreviewStreamingModeSchema,
        chunkMode: PreviewStreamingChunkModeSchema,
        preview: {
          type: "object",
          properties: {
            chunk: PreviewStreamingChunkSchema,
          },
          additionalProperties: false,
        },
        block: {
          ...
          properties: {
            ...
            coalesce: PreviewStreamingCoalesceSchema,
          },
          additionalProperties: false,
        },
      },
    ...
    PreviewStreamingModeSchema,
  ],
};

const SlackStreamingConfigSchema = {
  anyOf: [
    {
      type: "object",
      properties: {
  ...
  },
  {
    ...
    schema: {
      ...
      properties: {
        ...
        streaming: PreviewStreamingConfigSchema,
        streamMode: {
          type: "string",
  ...
  },
  {
    ...
    schema: {
      ...
      properties: {
        ...
        streaming: SlackStreamingConfigSchema,
        blockStreaming: {
          type: "boolean",
        },
        draftChunk: {
