...
function deriveConversationId(canonical) {
    ...
    if (canonical.channelId === "telegram" && baseConversationId) {
        const threadId = typeof canonical.threadId === "number" || typeof canonical.threadId === "string"
...
export function toPluginInboundClaimContext(canonical) {
...
export function toPluginInboundClaimEvent(canonical, extras) {
