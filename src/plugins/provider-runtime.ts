...
export function resolveProviderCapabilitiesWithPlugin(params: {
  ...
  workspaceDir?: string;
  env?: NodeJS.ProcessEnv;
}): Partial<import("../agents/provider-capabilities.js").ProviderCapabilities> | undefined {
  const capabilities = resolveProviderHookPlugin(params)?.capabilities;
  return capabilities && typeof capabilities === "object"
    ? (capabilities as Partial<import("../agents/provider-capabilities.js").ProviderCapabilities>)
    : undefined;
}
