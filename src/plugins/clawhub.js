...
import { ClawHubRequestError, downloadClawHubPackageArchive, fetchClawHubPackageDetail, fetchClawHubPackageVersion, parseClawHubPluginSpec, resolveLatestVersionFromPackage, satisfiesGatewayMinimum, satisfiesPluginApiRange, } from "../infra/clawhub.js";
...
export async function installPluginFromClawHub(params) {
    ...
    try {
        ...
        return {
            ...
            clawhub: {
                source: "clawhub",
                clawhubUrl: params.baseUrl?.trim() ||
