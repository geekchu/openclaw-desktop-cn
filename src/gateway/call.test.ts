...
describe("buildGatewayConnectionDetails", () => {
  ...
  it("emits a remote fallback note when remote url is missing", () => {
    ...
    expect(details.url).toBe("ws://127.0.0.1:28789");
    ...
    expect(details.message).toContain("Gateway target: ws://127.0.0.1:28789");
  });
...
describe("callGateway error details", () => {
  ...
  it("includes connection details when the gateway closes", async () => {
    ...
    closeCode = 1006;
    closeReason = "";
    setLocalLoopbackGatewayConfig(28789);
    ...
    expect(err?.message).toContain("Gateway target: ws://127.0.0.1:28789");
  ...
  it("includes connection details on timeout", async () => {
    ...
    expect(errMessage).toContain("Gateway target: ws://127.0.0.1:28789");
...
describe("callGateway url override auth requirements", () => {
  ...
  beforeEach(() => {
    ...
    resetGatewayCallMocks();
    setGatewayNetworkDefaults(28789);
  });
