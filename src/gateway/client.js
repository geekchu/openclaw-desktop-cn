...
import { ConnectErrorDetailCodes, readConnectErrorDetailCode, readConnectErrorRecoveryAdvice, } from "./protocol/connect-error-details.js";
    ...
    start() {
        ...
        if (!isSecureWebSocketUrl(url, { allowPrivateWs })) {
            ...
            const error = new Error(`SECURITY ERROR: Cannot connect to "${displayHost}" over plaintext ws://. ` +
                ...
                "(ssh -N -L 28789:127.0.0.1:28789 user@gateway-host), or use Tailscale Serve/Funnel. " +
                (allowPrivateWs
                    ? ""
