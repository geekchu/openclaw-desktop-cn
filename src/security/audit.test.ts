...
`,
  ...
  it.each([
    {
      ...
      detailIncludes: [
        ...
        "~/.openclawcn/credentials/discord-allowFrom.json:team.owner",
      ],
  ...
  it("warns when state/config look like a synced folder", async () => {
    ...
    const res = await audit(cfg, {
      ...
      configPath: "/Users/test/Dropbox/.openclawcn/openclaw.json",
    });
      ...
      const cases: Array<{
        ...
        },
        {
          ...
          cfg: {
            gateway: {
              ...
              remote: { url: "wss://remote.example.com:28789", token: "remote-token-xyz789" },
            },
          },
        ...
        },
        {
          ...
          cfg: {
            gateway: {
              mode: "remote",
              auth: { token: "local-token-should-not-use" },
              remote: { url: "wss://remote.example.com:28789", token: "remote-token" },
            },
          },
          env: { token: "env-token" },
        ...
        },
        {
          ...
          cfg: {
            gateway: {
              mode: "remote",
              remote: { url: "wss://remote.example.com:28789", password: "remote-pass" },
            },
          },
